...
return this.promisizer(jQuery.sap.getModulePath("Ejercicio20") + "/localService/" + sJsonName);
},
...
getOrderDetails: function() {
    let oRequest = this.getRequest({
        endPoint: "Northwind",
        method: "GET",
        entity: Constants.entity.orderDetails
        //entity: "/V3/Northwind/Northwind.svc/Orders(" + variable + ")"
        //https://services.odata.org/V3/Northwind/Northwind.svc/Orders(10248)

    });
    return this.promisizer(oRequest);
},

getOrders: function(nroOrder) {
    let oRequestOrders = this.getRequest({
        endPoint: "Northwind",
        method: "GET",
        entity: Constants.entity.orders + "(" + nroOrder + ")"
        //entity: "/V3/Northwind/Northwind.svc/Orders(" + variable + ")"
        //https://services.odata.org/V3/Northwind/Northwind.svc/Orders(10248)

    });
    return this.promisizer(oRequestOrders);
},
